          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('The Print Shack — Personalization', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
                  const Text('Personalize your product with custom text. Type below, pick a colour and size, and see a live preview.'),
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Personalized item added to cart (£25)')));
                              },
                              child: const Text('Add personalized product to cart — £25'),
                            ),
                          ],
                        ),
                      ),
